...
//?????????????????????????????????????
	...
	// ???????????  ?http://????????????id=123??????????????????
	public static String notify_url = "http://movie.free.idcfengye.com/home/pay/alipay_notify";

	// ???????????? ?http://????????????id=123??????????????????
	public static String return_url = "http://movie.free.idcfengye.com/home/account/user-account";
