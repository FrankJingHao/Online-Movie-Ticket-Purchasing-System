<div class="header">
    ...
    <div class="main-nav">
        <div class="container fn-clear">
            <div class="logo"><a href="/home/index/index"><img src="/home/images/img.png" alt="猿来入此电影票" title="猿来入此电影票" width="165"/></a></div>
            <div class="location" data-citycode="360100">
                <span class="lc"><#if movie_area??>${movie_area.name}<#else>请选择</#if></span>
                <ul class="other-city">
