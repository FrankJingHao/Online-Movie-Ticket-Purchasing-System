  ...
  <div class="lyear-layout-container">
    ...
    <aside class="lyear-layout-sidebar">
      ...
      <div id="logo" class="sidebar-header">
        <a href="index.html"><img src="/admin/images/img.png" title="${siteName!""}" alt="${siteName!""}" /></a>
      </div>
        ...
        <div class="row" id="show-copyright">
          <div class="col-sm-12 col-lg-12">
            <div class="card bg-primary">
              <div class="card-body clearfix">
                <div class="pull-left">
                  <p class="h3 text-white m-t-0">免责声明:</p>
                  <p class="h6 text-white m-b-0">猫眼电影<a href="${showTipsUtl}" style="color:red;margin-right:20px;">https://www.maoyan.com</a>本系统模仿猫眼电影制作用于本科生毕业设计，不用作商业用途</p>
                  <p class="h5 text-white m-b-0">copyright@吕竟豪 2021.1</p>
                </div>
              </div>
            </div>
          </div>
